...
│       └── best_v1_50.pt
├── database/            # 資料庫腳本
│   ├── init_database.sql              # 完整資料庫初始化（包含所有內容）
...
- **前端**：Vite dev server，自動 proxy 到後端
